...
/**
* br/com/expenseController/persistence/TagPersistencePOA.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ../expenseController.idl
* Terça-feira, 5 de Novembro de 2019 00h24min46s BRST
*/

public abstract class TagPersistencePOA extends org.omg.PortableServer.Servant
 implements br.com.expenseController.persistence.TagPersistenceOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         br.com.expenseController.Tag tag = br.com.expenseController.TagHelper.read (in);
       ...
       case 3:  // br/com/expenseController/persistence/TagPersistence/load
       {
         ...
         br.com.expenseController.Tag $result = null;
         $result = this.load (code);
         out = $rh.createReply();
         br.com.expenseController.TagHelper.write (out, $result);
         break;
       }
       ...
       case 4:  // br/com/expenseController/persistence/TagPersistence/loadAll
       {
         ...
         $result = this.loadAll ();
         out = $rh.createReply();
         br.com.expenseController.TagsHelper.write (out, $result);
         break;
       }
  ...
  public TagPersistence _this(org.omg.CORBA.ORB orb) 
  {
    return TagPersistenceHelper.narrow(
